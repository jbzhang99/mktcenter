...
public class ActivityManualController {
    ...
    */
     ...
     *创建活动
     */
    @RequestMapping("/addActivityManual")
   public  ResponseData<Integer> addActivityManual(Long couponId, ActivityVO activityVO, ActivityManualVO activityManualVO,HttpServletRequest request){
        //1.入参校验
        ActivityParamCheckUtil.checkManualParam(activityVO,activityManualVO,couponId) ;
        //取缓存
        // SysAccountPO stageUser = TokenUtils.getStageUser(request);
        SysAccountPO stageUser = new SysAccountPO();
        ResponseData<Integer> activityManualResponseData = activityManualService.addActivityManual(couponId,activityVO,activityManualVO,stageUser);
  ...
  /*  public  ResponseData<Integer> updateActivityManual(ActivityVO activityVO){
        return null;
    }*/
   /*
   * 查询活动效果
