...
public class SmsPlatformPOExample implements Serializable {
    /**
	 * 只读. 
     ...
     * This class corresponds to the database table t_def_sms_platform
     *
