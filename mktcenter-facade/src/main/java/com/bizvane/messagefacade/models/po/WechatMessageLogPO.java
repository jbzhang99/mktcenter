...
public class WechatMessageLogPO implements Serializable {
   ...
   * @mbg.generated  2018-07-31 16:15:01
   */
  @io.swagger.annotations.ApiModelProperty(value = "业务模型代码", name = "bussinessModuleCode", required = false,
      example = "")
  ...
  /**
   * 只读. 微信模板类型(消息内容). template_type
   * @mbg.generated  2018-07-31 16:15:01
   */
  @io.swagger.annotations.ApiModelProperty(value = "微信模板类型(消息内容)", name = "templateType", required = false,
      example = "")
  ...
  /**
   * 只读. 发送状态（发送结果）：00-新增；05-失败；10-成功；. send_state
   * @mbg.generated  2018-07-31 16:15:01
   */
  @io.swagger.annotations.ApiModelProperty(value = "发送状态（发送结果）：00-新增；05-失败；10-成功；", name = "sendState",
      required = false, example = "")
  private String sendState;
  /**
   * 只读. 出现错误是否支持重发. is_resend
   * @mbg.generated  2018-07-31 16:15:01
   */
