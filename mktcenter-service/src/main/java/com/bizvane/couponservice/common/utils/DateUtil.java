...
public class DateUtil {
    ...
    /**
     * 将原来的格式 转换成新的格式
     * 例如: yyyy-MM-dd HH:mm-ss  转成 yyyy-MM-dd
     *
     * @param strDate
     * @param originPattern
     * @param newPattern
    ...
    public static String interceptFormat(String strDate) {
        ...
        SimpleDateFormat df = new SimpleDateFormat(DateUtil.ymd);
        return df.format(DateUtil.stringToDate(strDate, DateUtil.ymdhms));
    }
    ...
    public static void main(String[] args) {
        System.out.println(interceptFormat("2018-05-03 00:00:00", DateUtil.ymdhms, DateUtil.ymd));
        System.out.println(format(addDay(new Date(), -3),"yyyy-MM-dd HH:mm:ss"));
    }
