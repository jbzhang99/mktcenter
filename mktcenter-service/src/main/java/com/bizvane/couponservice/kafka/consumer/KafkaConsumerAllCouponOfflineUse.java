...
// */
//
//@Service("KAFKA_TOPIC_ALL_COUPON_OFFLINE_USE")
//public class KafkaConsumerAllCouponOfflineUse implements KafkaConsumerService{
//
//  private static final Logger logger = LoggerFactory.getLogger(KafkaConsumerAllCouponOfflineUse.class);
//
//  @Autowired
...
//      ResponseData<Long> storeCodeResult = storeServiceRpc.getStoreIdByCode(offlineVO.getUseStoreCode());
...
//
//    logger.info("enter KafkaConsumerAllCouponOfflineUse consumer method sendMessage! param:responseData:{}",responseData);
//
