 ...
 */
@JobHandler(value="startRedPacket")
@Component
public class ActivityStartRedPacketHandler extends IJobHandler {
    @Autowired
    private MktActivityPOMapper mktActivityPOMapper;
    @Override
    public ReturnT<String> execute(String param) throws Exception {
        System.out.println("红包定时 ActivityStartRedPacketHandler param: "+param);
        ...
        returnT.setCode(0);
        returnT.setContent("红包定时 ActivityStartRedPacketHandler 活动执行完毕");
