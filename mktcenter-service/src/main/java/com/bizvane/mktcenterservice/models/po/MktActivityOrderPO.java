...
public class MktActivityOrderPO implements Serializable {
	...
	/**
	 * 只读. 商品限制，0不限制，1白名单，2黑名单. commodity_limit
	 * @mbg.generated  2018-08-16 16:31:22
	 */
	@io.swagger.annotations.ApiModelProperty(value = "商品限制，0不限制，1白名单，2黑名单", name = "commodityLimit", required = false, example = "")
	private Integer commodityLimit;
	/**
	 * 只读. 门店限制，0不限制，1白名单限制，2黑名单限制. store_limit
	 * @mbg.generated  2018-08-16 16:31:22
	 */
	@io.swagger.annotations.ApiModelProperty(value = "门店限制，0不限制，1白名单限制，2黑名单限制", name = "storeLimit", required = false, example = "")
