...
public class MktActivityUpgradePO implements Serializable {
	...
	/**
	 * 只读. pkid. mkt_activity_upgrade_id
	...
	/**
	 * 只读. 目标会员等级编号. mbr_level_code
	 * @mbg.generated  2018-08-28 18:01:34
	 */
	@io.swagger.annotations.ApiModelProperty(value = "目标会员等级编号", name = "mbrLevelCode", required = false, example = "")
	private String mbrLevelCode;
	/**
	 * 只读. 目标会员等级名称. mbr_level_name
	 * @mbg.generated  2018-08-28 18:01:34
	 */
	@io.swagger.annotations.ApiModelProperty(value = "目标会员等级名称", name = "mbrLevelName", required = false, example = "")
