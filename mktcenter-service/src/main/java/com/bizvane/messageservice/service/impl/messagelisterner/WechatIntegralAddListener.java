 ...
 */
@Component
public class WechatIntegralAddListener implements MessageListener {

    @Resource(name="wXTemplateMessageIntegralAddServiceImpl")
...
//        Runnable runnable = new ThreadExtend("wechatIntegralAddListener", "sendIntegralCustomer", message);
