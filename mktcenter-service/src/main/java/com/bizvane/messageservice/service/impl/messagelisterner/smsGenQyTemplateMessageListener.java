 ...
 */
@Component
public class smsGenQyTemplateMessageListener implements MessageListener {

    @Resource(name="smsGenYeTemplateMessageServiceImpl")
    ...
    public Action consume(Message message, ConsumeContext consumeContext) {
        ...
        logger.info("smsGenYeTemplateMessageServiceImpl消费消息 topic:" + message.getTopic() + " messageId:" + message.getMsgID());

//        Runnable runnable = new ThreadExtend("smsGenTemplateMessageListener", "sendMemberCustomer", message);
