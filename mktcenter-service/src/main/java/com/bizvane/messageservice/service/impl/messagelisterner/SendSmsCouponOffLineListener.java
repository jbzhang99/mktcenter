 ...
 */
@Component
public class SendSmsCouponOffLineListener implements MessageListener {

    @Resource(name="sendSmsTemplateMessageCouponOffLineServiceImpl")
    private SendSmsTemplateMessageService sendSmsTemplateMessageService ;

    @Autowired
    private RocketLogService rocketLogService;

    private static final Logger logger = LoggerFactory.getLogger(SendSmsCouponOffLineListener.class);
...
//        Runnable runnable = new ThreadExtend("sendSmsCouponOffLineListener", "sendSmsCouponCustomer", message);
