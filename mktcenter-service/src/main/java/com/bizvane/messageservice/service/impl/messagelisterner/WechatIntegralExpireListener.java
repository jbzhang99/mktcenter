 ...
 */
@Component
public class WechatIntegralExpireListener implements MessageListener {

    @Resource(name="wXTemplateMessageIntegralExpireServiceImpl")
    private WXTemplateMessageService wxTemplateMessageService;

    @Autowired
    private RocketLogService rocketLogService;

    private static final Logger logger = LoggerFactory.getLogger(WechatIntegralExpireListener.class);

    @Override
    public Action consume(Message message, ConsumeContext consumeContext) {

        logger.info("WXTemplateMessageIntegralExpireServiceImpl消费消息 topic:" + message.getTopic() + " messageId:" + message.getMsgID());
//
//        Runnable runnable = new ThreadExtend("wechatIntegralExpireListener", "sendIntegralCustomer", message);
...
//     * @param objectParam
//     */
//    public void sendIntegralCustomer(Object objectParam){
//
