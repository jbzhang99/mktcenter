 ...
 */
@Component
public class SmsMemberRegisterListener implements MessageListener {

    @Resource(name="smsTemplateMessageMemberRegisterServiceImpl")
    ...
    public Action consume(Message message, ConsumeContext consumeContext) {
        ...
        logger.info("SmsTemplateMessageMemberRegisterServiceImpl消费消息 topic:" + message.getTopic() + " messageId:" + message.getMsgID());

//        Runnable runnable = new ThreadExtend("smsMemberRegisterListener", "sendMemberCustomer", message);
