 ...
 */
@Component
public class smsGenTemplateMessageListener implements MessageListener {

    @Resource(name="smsGenTemplateMessageServiceImpl")
    ...
    public Action consume(Message message, ConsumeContext consumeContext) {
        ...
        logger.info("smsGenTemplateMessageServiceImpl消费消息 topic:" + message.getTopic() + " messageId:" + message.getMsgID());
