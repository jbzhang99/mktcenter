 ...
 */
@Component
public class WechatCouponSendListener implements MessageListener {

    @Resource(name="wXTemplateMessageCouponSendServiceImpl")
    ...
    public Action consume(Message message, ConsumeContext consumeContext) {
        ...
        logger.info("WXTemplateMessageCouponSendServiceImpl消费消息 topic:" + message.getTopic() + " messageId:" + message.getMsgID());

//       Runnable runnable = new ThreadExtend("wechatCouponSendListener", "sendCouponCustomer", message);
