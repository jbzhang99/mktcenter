 ...
 */
@Component
public class SendSmsCouponExpireListener implements MessageListener {

    @Resource(name="sendSmsTemplateMessageCouponExpireServiceImpl")
    private SendSmsTemplateMessageService sendSmsTemplateMessageService ;

    @Autowired
    private RocketLogService rocketLogService;

    private static final Logger logger = LoggerFactory.getLogger(SendSmsCouponExpireListener.class);
...
//        Runnable runnable = new ThreadExtend("sendSmsCouponExpireListener", "sendSmsCouponCustomer", message);
