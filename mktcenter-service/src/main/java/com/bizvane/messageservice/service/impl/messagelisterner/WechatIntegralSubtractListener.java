 ...
 */
@Component
public class WechatIntegralSubtractListener implements MessageListener {

    @Resource(name="wXTemplateMessageIntegralSubtractServiceImpl")
    private WXTemplateMessageService wxTemplateMessageService;

    @Autowired
    private RocketLogService rocketLogService;

    private static final Logger logger = LoggerFactory.getLogger(WechatIntegralSubtractListener.class);

    @Override
    public Action consume(Message message, ConsumeContext consumeContext) {

        logger.info("WXTemplateMessageIntegralSubtractServiceImpl消费消息 topic:" + message.getTopic() + " messageId:" + message.getMsgID());

//        Runnable runnable = new ThreadExtend("wechatIntegralSubtractListener", "sendCouponCustomer", message);
...
//     * @param objectParam
//     */
//    public void sendCouponCustomer(Object objectParam){
//
