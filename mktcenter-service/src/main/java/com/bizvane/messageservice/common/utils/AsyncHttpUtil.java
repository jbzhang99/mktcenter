...
public class AsyncHttpUtil {
  ...
  public static String doPost(String apiUrl, String jsonStr) {
    return AsyncHttpUtil.doPost(apiUrl, jsonStr, null, null, null);
  }

  public static String doPost(String apiUrl, String jsonStr, Map<String, Object> params) {
    return AsyncHttpUtil.doPost(apiUrl, jsonStr, params, null, null);
  }

  public static String doPost(String apiUrl, String jsonStr, FutureCallback<HttpResponse> futureCallback) {
    return AsyncHttpUtil.doPost(apiUrl, jsonStr, null, futureCallback, null);
  }

  public static String doPost(String apiUrl, String jsonStr, Map<String, Object> params,
      FutureCallback<HttpResponse> futureCallback) {
    return AsyncHttpUtil.doPost(apiUrl, jsonStr, params, futureCallback, null);
  }

  public static String doPost(String apiUrl, String jsonStr, FutureCallback<HttpResponse> futureCallback,
      Map<String, String> headerParams) {
    return AsyncHttpUtil.doPost(apiUrl, jsonStr, null, futureCallback, headerParams);
  }
