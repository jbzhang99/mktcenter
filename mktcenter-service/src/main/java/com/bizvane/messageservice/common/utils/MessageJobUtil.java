...
public class MessageJobUtil {
    ...
    public ResponseData<Integer> sendCouponExpireJob(){
        ...
        String jobHandler ="SEND_EXPIRE_JOBHANDLER";//、JobHandlerConstants.SEND_EXPIRE_JOBHANDLER;
        String taskName ="SEND_EXPIRE_JOBHANDLER"; //SystemConstants.COUPON_EXPIRE_DESC;
    ...
    public ResponseData<Integer> addSendCouponBatchJob(SendCouponBatchRequestVO param) {
        ...
        //如果手动发券类型为指定时间，则调用定时任务
//        String jobHandler = "SEND_BATCH_JOBHANDLER";//JobHandlerConstants.SEND_BATCH_JOBHANDLER;
